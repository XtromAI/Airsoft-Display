...
// --- Core 0 Functions (Data Acquisition & Processing) ---

void core0_main() {
    printf("Core 0: Starting data acquisition and processing...\n");
    ...
    while (true) {
        ...
        // Blink status LED to show Core 0 is running
...
int main() {
    ...
    // Launch Core 0 for data acquisition
    multicore_launch_core1(core0_main);
    printf("Core 1: Core 0 launched for data acquisition\n");
    
    // Core 1: Initialize display and UI
    printf("Core 1: Initializing display...\n");
    ...
    // Initialize display
    if (!display.begin()) {
        printf("Core 1: Display initialization failed!\n");
        while (1) sleep_ms(1000);
    }
    
    printf("Core 1: Display initialized successfully!\n");
    ...
    // Core 1 main loop: Display and UI
    while (1) {
        // Read shared data from Core 0 (with mutex protection)
        ...
        if (data_available || (display_update_counter % 100 == 0)) {
            ...
            // Display Core status
            display.drawString(10, 70, "Core0: Running");
            display.drawString(10, 90, "Core1: Display");
        ...
        if (display_update_counter % 1000 == 0) {
            printf("Core 1: Running display demo...\n");
